...
`ifdef RVFI
  ...
  logic        perf_load;
  logic        perf_store;
  logic        perf_ic_tag_read;
  logic        perf_ic_data_read;
  logic        perf_ic_tag_write;
  logic        perf_ic_data_write;
  logic        perf_ic_evict;
  logic        perf_ic_inval_tag_write;
  ...
  ibex_if_stage #(
    ...
    .if_busy_o          (if_busy)
    ,
    .perf_ic_tag_read_o       (perf_ic_tag_read),
    .perf_ic_data_read_o      (perf_ic_data_read),
    .perf_ic_tag_write_o      (perf_ic_tag_write),
    .perf_ic_data_write_o     (perf_ic_data_write),
    .perf_ic_evict_o          (perf_ic_evict),
    .perf_ic_inval_tag_write_o(perf_ic_inval_tag_write)
  );
  ...
  ibex_cs_registers #(
    ...
    .ic_tag_read_i              (perf_ic_tag_read),
    .ic_data_read_i             (perf_ic_data_read),
    .ic_tag_write_i             (perf_ic_tag_write),
    .ic_data_write_i            (perf_ic_data_write),
    .ic_evict_i                 (perf_ic_evict),
    .ic_inval_tag_write_i       (perf_ic_inval_tag_write)
  );
