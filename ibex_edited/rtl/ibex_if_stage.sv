  ...
  if (ICache) begin : gen_icache
    ...
    ibex_icache #(
      ...
      .LineSizeECC     (LineSizeECC)
        ...
        .perf_ic_tag_read_o       ( perf_ic_tag_read_o        ),
        .perf_ic_data_read_o      ( perf_ic_data_read_o       ),
        .perf_ic_tag_write_o      ( perf_ic_tag_write_o       ),
        .perf_ic_data_write_o     ( perf_ic_data_write_o      ),
        .perf_ic_evict_o          ( perf_ic_evict_o           ),
        .perf_ic_inval_tag_write_o( perf_ic_inval_tag_write_o )
    );
    ...
    assign perf_ic_tag_read_o        = 'b0;
    assign perf_ic_data_read_o       = 'b0;
    assign perf_ic_tag_write_o       = 'b0;
    assign perf_ic_data_write_o      = 'b0;
    assign perf_ic_evict_o           = 'b0;
    assign perf_ic_inval_tag_write_o = 'b0;
